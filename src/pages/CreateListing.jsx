...
const handleImageSubmit = (e) => {
  if(files.length > 0 && files.length+formData.imageUrls.length <7){
    ...
    Promise.all(promises).then((urls) => {
      ...
      setImageUploadError('Image Upload failed (2mb max per page)');
      setUploading(false);
    })
        ...
        <div className='flex flex-col gap-4 flex-1'>
         ...
         />
            ...
            <div className='flex gap-2'>
              ...
              checked={formData.parking} className='w-5'/>
          ...
          <div className="flex flex-wrap gap-6">
            <div className="flex items-center gap-2">
              ...
              max='10' 
              required 
              className='p-3 border border-gray-300 rouned-lg'
              onChange={handleChange}
...
{formData.offer &&( <div className="flex items-center gap-2">
              ...
              checked={formData.discountPrice} id='discountPrice' min='1' max='10' required className='p-3 border border-gray-300 rouned-lg'/>
              <div className='flex flex-col items-center'>
        ...
        <div className="flex flex-col flex-1 gap-4">
            ...
            <div className="flex gap-4">
              ...
              id="image/*" 
              multiple />
   <p className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80'>{imageUploadError && imageUploadError}</p>
   {
